...
//endregion
  ...
  List<_Account> allChoices;
}

class _WidgetAddAnAccount extends HDMStatelessWidget<AddAnAccountController> {
  _WidgetAddAnAccount(AddAnAccountController app, HDMBox box) : super(app, box);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(itemBuilder: (context, i) {
        ...
        return ListTile(title: Text(account.name), leading: account.icon, onTap: account.create);
      }),
    );
  }
}
